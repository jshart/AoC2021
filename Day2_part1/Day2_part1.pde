...
String filebase = new String("C:\\Users\\jsh27\\OneDrive\\Documents\\GitHub\\AoC2021\\Day2_part1\\data\\mydata");
...
void setup() {
  ...
  {
    temp = new Direction(input.lines.get(i));
    temp.printDirection();
    directionList.add(temp);
    pos.updatePosition(temp);
    pos.printPosition();
    println();
  }
  
  println("FINAL ANSWER="+pos.compute());
}
...
public class Position
{
  ...
  {
    print("D="+depth+" H="+horizontal);
  }
  
  public long compute()
  {
    return((long)depth * (long)horizontal);
  }
}
