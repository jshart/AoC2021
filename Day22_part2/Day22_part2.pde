...
String filebase = new String("C:\\Users\\jsh27\\OneDrive\\Documents\\GitHub\\AoC2021\\Day22_part2\\data\\example");
...
void setup() {
  ...
  Voxel v1=voxelList.get(i-2).normaliseToPositive();
  Voxel v2=voxelList.get(0).normaliseToPositive();
  println(v1.rangeToText());
  println(v2.rangeToText());
}
